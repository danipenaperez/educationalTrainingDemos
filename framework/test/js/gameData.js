/**
 * Contiene la informacion completa acerca del juego
 */

var options = [
{word:"I [inputText] watching [inputText].", correct: "I am watching TV", example: "Yo estoy viendo la tele."},
{word:"I [inputText] watching [inputText].", correct: "I am watching TV", example: "Yo estoy viendo la tele."},
];
...
var options =[
    {word:"do", correct: "hacer"},
    {word:"go", correct: "ir"},
    {word:"listen to", correct: "escuchar"},
    {word:"play", correct: "jugar | tocar"},
    {word:"read", correct: "leer"},
    {word:"ride", correct: "montar en"},
    {word:"watch", correct: "observar"}
